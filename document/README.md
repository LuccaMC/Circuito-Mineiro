...
| GitHub Pages | Plataforma de deploy e hospedagem do site |
...
|   `-- contato.html            (página dedicada ao formulario de contato)
|
|-- css/
|   |-- style.css
|   |-- style_cidades.css
...
Formulário dedicado para o usuário enviar o contato pessoal para receber a consultoria.
